...
\chapter{Resultate\label{chap:Resultate}}
  ...
  \section{Allgemeine Lösung - vierter Simulationslauf\label{sec:4lauf}}
    ...
    \subsection{Auswertung}
      ...
      \subsubsection{11000. Generation}
        ...
        wird die Endpopulation aus dem vierten Lauf im sechsten Lauf~(\vref{sec:sixthSimulation}) weiter evolviert.
  ...
  \section{Sechster Versuch, Fortsetzung von Simmulationslauf vier\label{sec:sixthSimulation}}
