...
\chapter{Resultate\label{chap:Resultate}}
  ...
  \section{Allgemeine Lösung - 1. Simulationslauf}
  ...
  \section{Allgemeine Lösung - 2. Simulationslauf}
  ...
  \section{Allgemeine Lösung - 3. Simulationslauf}
  ...
  \section{Allgemeine Lösung - 4. Simulationslauf}
  ...
  \section{Evolvieren auf Evolvierbarkeit - 1. Simulationslauf}
    ...
    \subsection{Auswertung\label{sub:fifthAuswertung}}
      ...
      Der Graph in~\vref{fig:graphFifth} schlägt weniger aus im Vergleich zu~\vref{fig:graphForth}.
