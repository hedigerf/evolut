...
% TODO n. Versuch umbenennen -> ?
% was wird in versuch x gemacht
% TODO grafiken zu generation 3000., 7000. ... verbessern
...
\chapter{Resultate\label{chap:Resultate}}
  ...
  \section{Allgemeine Lösung - 1. Simmulationslauf}
    ...
    \subsection{Auswertung}
      ...
      sollte auf 0.02 gesetzt werden. Mit der Herabsetzung dieser Werte werden weniger Mutation durchgeführt und die Lösungsmenge nicht zu stark eingegrenzt werden.
  ...
  \section{Allgemeine Lösung - 2. Simmulationslauf}
  ...
  \section{Allgemeine Lösung - 3. Simmulationslauf}
  ...
  \section{Allgemeine Lösung - 4. Simmulationslauf}
    ...
    \subsection{Konfiguration}
      ...
      Dies sollte verhindern, dass die Datenstrukturen durch die hinzukommenden Bewegungen zu gross werden und den benötigten Rechenaufwand in die Höhe treiben.
    ...
    \subsection{Auswertung}
      ...
      \subsubsection{3000. Generation\label{subsub:3000gen}}
        ...
        Da die Individuen sich vom Boden korrekt mit einem Bein abstossen, sich nicht im Boden verhacken und durch die zu späte fehlerhafte Kollisionerkennung abgestossen werden.
  ...
  \section{Evolvieren auf Evolvierbarkeit - 1. Simmulationslauf}
