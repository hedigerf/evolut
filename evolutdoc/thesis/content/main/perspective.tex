...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    wie die Leistungen anderer Implementationen von Javascript-Engines im Vergleich zu V8 abschneiden. % TODO ref
    ...
    \subsection{Individuum: Allgemeine Lösung vs.\ Evolvieren auf Evolvierbarkeit}
      ...
      dies ist auch der Grund, warum dass Individum aus der allgemeinen Lösung einen besseren Fitnesswert aufweisen kann.
      ...
      \\
      Die Resulatate sprechen für sich, mit der allgemeinen Lösung konnten fittere Individuen gefunden werden.
