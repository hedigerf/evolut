...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Hypothese Mutationswahrscheinlichkeiten}
      ...
      Insbesondere auf die Entwicklung des Bewegungsablaufs hat dies grosse Auswirkungen.
      Mit kleineren Wahrscheinlichkeiten werden feinere Änderungen vorgenommen,
      die dann in der Simulation ausgewertet werden.

      \ldots TODO

      % TODO discuss

      % zu viele mutation -> wertvolle lösungen verspielt
      % zu viele änderung für sinnvolle mutation
