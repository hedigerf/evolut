...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Wie sieht der Bewegungsablauf und die Geometrie eines evolvierten Tieres aus?}
      ...
      Es wird erwartet, dass die Indivdiuen eine Bewegung entwickelt,
  ...
  \section{Ausblick\label{sec:ausblick}}
    ...
    \subsection{Hypothese Selektionsstrategie\label{sub:hypoSelect}}
      ...
      Rangselektion und proportionale Selektion auf die Simulationsresultate zu untersuchen.
    ...
    \subsection{Parcours}
      ...
      Sandige Terrains sind ein weicher Untergrund und benötigen deshalb andere Eigenscahften.
      \\
      ...
      Darin werden alle Anforderung kombiniert und das Indidivuum muss diese abdecken.
