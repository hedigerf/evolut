...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Wie kann die Geometrie der Tiere evolviert werden?}
      ...
      Man könnte den Ansatz der Konstruierung mit Hilfe eines Kreises jedoch erweitern.
      Um mit bestimmten Formen Simulationsläufe durchzuführen, könnten Bediengungen für die Körperpunkte formulieren werden,
      so dass sie nur in definierten Bereichen gesetzt werden dürfen.
  ...
  \section{Ausblick\label{sec:ausblick}}
    ...
    \subsection{Feedback an den Bewegungsmotor\label{sub:PerspectiveFeedback}}
      ...
      Mit einem Feedback-System können Ereignisse (Boden berühren, Steigung, Abhang) erkannt und verarbeitet werden.
      ...
      In dieser Arbeit ist bereits vorhanden, dass erkannt wird, wann ein Bein den Boden berührt.
