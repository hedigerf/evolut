...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Individuum: Allgemeine Lösung vs Evolvieren auf Evolvierbarkeit}
      Es wird das beste Indivdiuum der 4000. Generation~\vref{fig:gen4000} aus dem vierten Simulationslauf~\vref{sec:4lauf} und dem füften Simulationslauf~\vref{sec:5lauf} miteinander verglichen.
      Die Individuen haben beide eine Hüpfbewegung entwickelt. Jedoch streckt das eine Individum~(\vref{fig:gen4000_alg}) alle Beine, während das Andere~(\vref{fig:gen4000_ev}) fast alle Beine angewinkelt hat.
      Ebenso weisst der Körper des Individuums, welches auf Evolvierbarkeit evolviert wurde, eine grössere Masse auf. Die Masse aller Beine ist folglich grösser beim Individum der allgemeinen Lösung.
