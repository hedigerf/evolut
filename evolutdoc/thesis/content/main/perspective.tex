...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Wie kann eine Steuerung der Bewegung implementiert werden?}
      ...
      Die erzeilten Resultate mit der Implementation des Motors sind zufriedenstellend.
      ...
      Mit den zusätzlichen Bewegugnen kann das Individuum seinen Bewegungsablauf an weitere Geländeformationen adaptieren
      und erreicht somit eine höhere Fitness.
    ...
    \subsection{Wie sieht der Bewegungsablauf und Geometrie eines evolvierten Tieres aus?}
      ...
      Die Ruderer in~\vref{fig:ruder} benutzen ein Bein um die Bewegung durchzuführen, alle anderen Beine verharren starr am Körper.
