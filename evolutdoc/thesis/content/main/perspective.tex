...
\chapter{Diskussion und Ausblick\label{chap:perspective}}
  ...
  \section{Diskussion der Resultate\label{sec:diskRes}}
    ...
    \subsection{Wie kann eine Steuerung der Bewegung implementiert werden?}
      ...
      Die Steuerung der Bewegung ist in zwei Teile aufgeteilt.
      Einerseits in die Daten und andererseits in die Logik, der Motor.
      \\
      Dies bietet mehrere Vorteile.
      Die Mutation arbeitet mit einer einfachen Repräsentation des Bewegungsablaufs.
