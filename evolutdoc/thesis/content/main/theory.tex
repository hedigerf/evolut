  ...
  \subsection{Schritte eines evolutionären Algorithmus\label{sub:stepsEvAlgo}}
    ...
    Die genetische Repäsentation beschreibt die Elemente eines Genomes und wie diese in einen Phänotyp gemapped werden \cite[S.16]{book:bioInspired}.
      ...
      \paragraph{Diskrete Repräsentation\label{par:GeneticRepresentationDiscrete}}
        ...
        Jeder Buchstabe in der Sequenz repräsentiert dabei einen Ort, welchen es zu besuchen gilt \cite[S.18]{book:bioInspired}.

        \begin{figure}[H]
          \includegraphics[scale=1]{graphics/discret_representation}
          \caption{Beispiel Diskrete Repräsentation \cite[S.18]{book:bioInspired}}
        \end{figure}
