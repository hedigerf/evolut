...
\section{Artifical Evolution}
    ...
    \subsection{Rekombinationsfunktion}
        ...
        \end{figure}
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %%% Achtung evtl bilder von https://en.wikipedia.org/wiki/Crossover_(genetic_algorithm) und für aritmetic selber zeichnen
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        \subsubsection{One-Point Crossover}

          Es wird ein zufälliger Cross-Over Punkt bestimmt an dem die Gene des Paares vertauscht werden ( a) \vref{sub:artenEvAlgos}).
        ...
        \begin{figure}[H]
          \includegraphics[scale=0.5, center]{graphics/crossover_types}
