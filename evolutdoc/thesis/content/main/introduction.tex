...
\chapter{Einleitung}
  ...
  übernehmen dabei die Rolle des Lösens und Optimierens einer Problemstellung.
  Für die Veränderung der Population sorgt der \nameref{subsub:SelectionPressure} (\vref{subsub:SelectionPressure}).
  Dadurch reproduzieren sich Individuen mit grösserer Fitness mit höherer Wahrscheinlichkeit,
  was zu Veränderung führt.
  \\
  In dieser Arbeit wird versucht mit evolutionären Algorithmen Individuen zu entwickeln,
  die lernen zu laufen und einen Parcours bewältigen können.
