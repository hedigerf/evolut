...
\chapter{Einleitung}
  ...
  ist das Lösen und Optimieren von Problemnstellungen eine aufwendige Aufgabe.
  Es wird viel Fachwissen gefordert und ist zeit- und ressourcenintensiv.
  Sobald der Lösungsraum eines Problems zu komplex wird, \ldots % TODO
  ...
  Das Konzept ist der natürlichen Evolution nachempfunden. Durch ``trial and error'' werden neue Lösungen generiert.
  Die Algorithmen nutzen eine Population, die die möglichen Lösungen beinhaltet.
  Mit dem Prinzip ``surival of the fittest'' werden immer bessere Näherungen für ein Problem produziert.
  \\
  %TODO 4 begriffe
  \\
  In dieser Arbeit wird versucht mit evolutionäre Algorithmen Individuen zu entwickeln, \ldots
