...
\chapter{Einleitung}
  ...
  \section{Zielsetzung}
    ...
    in einer zweidimensionalen Umgebung das Gehen zu lernen.
    ...
    Zur Implementierung soll eine bestehende Physik-Engine verwendet werden.
    Der Hauptfokus liegt auf dem Evolvieren der artifiziellen Tiere und nicht auf dem Ausbau der Physik-Engine.
  ...
  \section{Anforderungen}
    ...
    \subsection{Fitnessfunktion}
      ...
      In frühen Generation kann es vorkommen,
      dass die künstlichen Tiere sich keinen Schritt weit während der Simulation fortbewegen können.
