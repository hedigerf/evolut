...
\chapter{Methoden\label{sec:method}}
  ...
  \section{Design der Individuen}
    ...
    \subsection{Beine\label{sub:Beine}}
      ...
      Da als Grundkonzept ein \gls{Hexapod} verwendet wird, wird die Eigenschaft von 6 Beinen übernommen.
  ...
  \section{Konfiguration\label{sec:Konfiguration}}
    ...
    Bei der Evolvierung auf Evolvierbarkeit wird der Parcours nur dann neu generiert,
