...
\chapter{Methode}
  ...
  \section{Design der Individuen}
    ...
    \subsection{Beine\label{sub:Beine}}
      ...
      %Da als Grundkonzept ein \gls{Hexapod} verwendet wird, wird die auch die Eigenschaft übernommen,
    %dass das Individuum 6 Beine besitzt.
      %Mit 6 Beinen

      % TODO warum
      %%\\
      %Der Aufbau der Beine

      % analog zur natur
      % simplifikation -> kein fuss
      ...
      \subsubsection{Masse\label{subsub:Masse}}
  ...
  \section{Ablauf\label{sec:Ablauf}}
    ...
    \subsection{Mutation\label{sec:Mutation}}
      ...
      Limiten~(\vref{}) wurden definiert, um nicht gewinnbringende Lösung zu verhindern.
