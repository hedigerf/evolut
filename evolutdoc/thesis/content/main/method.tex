...
\chapter{Methode}
  ...
  \label{sec:Initiale Polulation}
    ...
    um eine breite Diversität zu erhalten. Es werden jeweils 20 Individuen mit 4,6,7 und 8 Körperpunkten \ref{sub:Körper} generiert.
    Die Verantwortliche Klasse in JavaScript ist der InitalPopulationGenerator.
