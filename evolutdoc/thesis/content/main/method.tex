...
\chapter{Methode}
  ...
  \section{Motor\label{sec:Engine}}
    ...
    \\
    Mit diesen Informationen ist es dem Motor möglich, die Bewegung kontrollieren.
    Der Motor überwacht die Übergänge zwischen einzelnen Bewegugnen oder Bewegungsgruppen.
    Nach jedem Übergang zu einer neuen Bewegung wird diese
    \\
