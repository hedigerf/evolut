...
\chapter{Methode}
  ...
  \section{Design der Individuen}
    ...
    Der Ansatz für das Design der Individuen wird angelehnt an \Glspl{Hexapod}, ein Unterstamm der Gliederfüsser.
    ...
    \subsection{Motor\label{sub:Engine}}
      ...
      \todo[inline]{Bewegung mit Bildern darstellen}
  ...
  \section{Auswahl des Evolutionären Algorithmus}
    ...
    \begin{itemize}
      ...
      \item Evolutionäre Strategie~\ref{item:evStrat}
