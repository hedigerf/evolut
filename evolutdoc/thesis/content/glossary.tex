...
\newglossaryentry{asyncMessaging}
{
  ...
  description={Beim asnychronen Messaging tauschen Prozesse Daten über Nachrichten aus, welche sie sich gegenseitig schicken.
              Asynchron bedeutet das Sender und Empfänger nicht auf Nachrichten warten, sondern anderen Rechenaufgaben nachgehen können.
              Erst wenn eine Nachricht empfangen wird, fokusiert sich der Prozess auf das Abarbeiten der Nachricht.}
}
